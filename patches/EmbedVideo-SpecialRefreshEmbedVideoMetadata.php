...
class SpecialRefreshEmbedVideoMetadata extends UnlistedSpecialPage {
	...
	/**
	 * The permission required to use this special page.
	 *
	 * Upstream passes this to the parent constructor as the $restriction
	 * argument. MediaWiki 1.46 deprecated that parameter - UnlistedSpecialPage
	 * documents "override the method getRestriction() instead" - so declaring
	 * it here keeps the identical permission check without tripping the
	 * deprecation warning.
	 *
	 * @return string
	 */
